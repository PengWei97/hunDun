...
for iCases = 1:length(inputDataFiles)
  ...
  plotCSVDataCurve(inputDir, simCase, iCases, lengthNames{iCases}, columnNames, visualizationParams);
end
...
% scripts\p23-GNSNi-AGG-2024\simulations\sim02_draw_ave_kinetics.m
